...
"""
    idfy_rest_client.models.attachment_request_wrapper
...
class AttachmentRequestWrapper(object):
    ...
    """Implementation of the 'AttachmentRequestWrapper' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AttachmentRequestWrapper class"""
