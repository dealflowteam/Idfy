...
"""
    idfy_rest_client.models.fullmakt_person

    This file was automatically generated for Idfy by APIMATIC v2.0 ( https://apimatic.io )
"""
from idfy_rest_client.api_helper import APIHelper
import idfy_rest_client.models.verv_data

class FullmaktPerson(object):

    """Implementation of the 'FullmaktPerson' model.
    ...
    Attributes:
        ...
        verv_field (list of VervData): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the FullmaktPerson class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('vervField') != None:
            ...
            for structure in dictionary.get('vervField'):
                verv_field.append(idfy_rest_client.models.verv_data.VervData.from_dictionary(structure))
