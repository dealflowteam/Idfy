...
"""
    idfy_rest_client.models.person_scoring

    This file was automatically generated for Idfy by APIMATIC v2.0 ( https://apimatic.io )
"""
import idfy_rest_client.models.person_arsaks_data

class PersonScoring(object):

    """Implementation of the 'Person.Scoring' model.

    TODO: type model description here.

    Attributes:
        beslutning_field (string): TODO: type description here.
        arsaks_data_field (list of PersonArsaksData): TODO: type description
            here.
    ...
    def __init__(self,
        ...
        """Constructor for the PersonScoring class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('arsaksDataField') != None:
            ...
            for structure in dictionary.get('arsaksDataField'):
                arsaks_data_field.append(idfy_rest_client.models.person_arsaks_data.PersonArsaksData.from_dictionary(structure))
