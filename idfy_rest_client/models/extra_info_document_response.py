...
"""
    idfy_rest_client.models.extra_info_document_response

    This file was automatically generated for Idfy by APIMATIC v2.0 ( https://apimatic.io )
"""
import idfy_rest_client.models.results_206
import idfy_rest_client.models.special_properties

class ExtraInfoDocumentResponse(object):

    """Implementation of the 'ExtraInfoDocumentResponse' model.

    TODO: type model description here.

    Attributes:
        results (Results206): Results as a dictionary with json
    ...
    def __init__(self,
        ...
        """Constructor for the ExtraInfoDocumentResponse class"""
    ...
    def from_dictionary(cls,
        ...
        results = idfy_rest_client.models.results_206.Results206.from_dictionary(dictionary.get('results')) if dictionary.get('results') else None
