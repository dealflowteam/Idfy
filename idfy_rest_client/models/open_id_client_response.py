...
"""
    idfy_rest_client.models.open_id_client_response
...
class OpenIdClientResponse(object):
    ...
    """Implementation of the 'OpenIdClientResponse' model.
    ...
    Attributes:
        ...
        identity_provider_restrictions (list of IdentityProviderRestriction):
            List of Identityproviders allowed. This requires setup on your
            account.
    ...
    def __init__(self,
        ...
        """Constructor for the OpenIdClientResponse class"""
