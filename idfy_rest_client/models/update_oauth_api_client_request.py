...
"""
    idfy_rest_client.models.update_oauth_api_client_request
...
class UpdateOauthAPIClientRequest(object):
    ...
    """Implementation of the 'UpdateOauthAPIClientRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateOauthAPIClientRequest class"""
